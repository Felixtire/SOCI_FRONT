...
import { TelaCriarPublicacao } from './telas/telas-derivadas-home/tela-criar-publicacao/tela-criar-publicacao';
...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {path:'criar-publicacao', component: TelaCriarPublicacao},
